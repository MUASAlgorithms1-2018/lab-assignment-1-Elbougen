...
bool tester_mss(int want, int arr[], int n);
...
//----------------------------
    ...
    if (tester_mss(want1, arr1, n1))
        succeeded++;
    else
        failed++;
//----------------------------
    int want2 = 22;
    int arr2[] = {1, 2, -30, 5, 5, -8, 20};
    int n2 = sizeof(arr2) / sizeof(int);
    if (tester_mss(want2, arr2, n2))
        succeeded++;
    else
        failed++;
//----------------------------
    int want3 = 0;
    int arr3[] = {-1, -2, -30, -5, -5, -8, -20};
    int n3 = sizeof(arr3) / sizeof(int);
    if (tester_mss(want3, arr3, n3))
        succeeded++;
    else
        failed++;
//----------------------------
...
//----------------------------
    ...
    if (tester_mss(want7, arr7, n7))
        succeeded++;
    else
        failed++;
//----------------------------
    int want8 = 46168;
    int arr8[] = {961, 628, 74, 865, 532, 947, 291, 264, 739, 113, 228, 739, 192, 591, 104, 836, 102, 529, 87, 370, 875, 102, 300, 398, 838, 573, 717, 165, 816, 192, 893, 280, 277, 879, 7, 465, 97, 277, 95, 979, 791, 418, 759, 374, 203, 209, 418, 534, 499, 888, 726, 372, 279, 176, 766, 889, 548, 587, 755, 58, 525, 282, 975, 747, 88, 923, 297, 120, 423, 67, 62, 362, 469, 672, 219, 756, 340, 664, 223, 901, 475, 214, 631, 629, 763, 499, 207, 629, 626, 354, 850, 387, 528, 188, 395, 50, 299, 7, 303, 353};
    int n8 = sizeof(arr8) / sizeof(int);
    if (tester_mss(want8, arr8, n8))
        succeeded++;
    else
        failed++;
//----------------------------
...
bool tester_mss(int want, int arr[], int n) {
    ...
    cout << "cubic have: ";
    int have_cub = cubic_mss(arr, n);
    bool result_cub = want == have_cub;
    cout << have_cub;
    if (result_cub)
        cout << " succeeded" << endl;
    else
    ...
    cout << "quadratic have: ";
    int have_quad = quadratic_mss(arr, n);
    bool result_quad = want == have_quad;
    cout << have_quad;
    if (result_quad)
        cout << " succeeded" << endl;
    else
    ...
    cout << "linear have: ";
    int have_lin = linear_mss(arr, n);
    bool result_lin = want == have_lin;
    cout << have_lin;
    if (result_lin)
        cout << " succeeded" << endl;
    else
    ...
    cout << "--------" << endl;
    return result_cub and result_quad and result_lin;
}